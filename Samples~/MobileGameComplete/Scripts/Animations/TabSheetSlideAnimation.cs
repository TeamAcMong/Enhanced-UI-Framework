...
using EnhancedUI.Demo;

namespace EnhancedUI.Demo.Animations
{
    /// <summary>
    /// Horizontal slide animation for tab sheets compatible with EnhancedUI framework
